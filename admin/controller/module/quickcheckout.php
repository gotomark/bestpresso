    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            if (!isset($this->request->get['continue'])) {
                ...
                $this->response->redirect($this->url->link('module/quickcheckout', 'user_token=' . $this->session->data['user_token'], 'SSL'));
            }
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('module/quickcheckout', 'user_token=' . $this->session->data['user_token'], 'SSL')
        );

        $data['action'] = $this->url->link('module/quickcheckout', 'user_token=' . $this->session->data['user_token'], 'SSL');
        $data['continue'] = $this->url->link('module/quickcheckout', 'user_token=' . $this->session->data['user_token'] . '&continue=1', 'SSL');
        ...
        $this->response->setOutput($this->load->view('module/quickcheckout', $data));
    }
